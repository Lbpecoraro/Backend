...
let contenedorcito = new Contenedor('./productos.txt');

// Obtener todos los productos
productRouter.get('/',middlewareAutenticacion,async (req,res) => {
    let allProducts = await contenedorcito.getAll();
...
productRouter.get('/:id',middlewareAutenticacion,async (req,res) => {
    ...
    let prodSelected = await contenedorcito.getById(parseInt(req.params.id));
...
productRouter.delete('/:id',middlewareAutenticacion,middlewareAutorizacion,async (req,res) => {
    let prodDeleted = await contenedorcito.deleteById(parseInt(req.params.id));
